...
<head>
    ...
    <title>Lịch Làm Việc - ${employee.fullName} - Manager - Hệ Thống Quản Lý Phòng Khám Nha Khoa</title>
            ...
            <div class="container">
                ...
                <div class="employee-schedule-container">
                    ...
                    <div class="action-buttons">
                        <a href="${pageContext.request.contextPath}/manager/schedules?employeeId=${employee.userId}" class="btn btn-primary">
                            Phân Công Lịch Mới
                        </a>
                        <a href="${pageContext.request.contextPath}/manager/employees" class="btn btn-secondary">
                            Quản Lý Nhân Viên
                        </a>
                        <a href="${pageContext.request.contextPath}/manager/weekly-schedule" class="btn btn-success">
                            Lịch Tuần Tổng Thể
                        </a>
                    </div>
                </div>
