...
<head>
    ...
    <title>Lịch làm việc của tôi - Lễ tân</title>
...
<c:if test="${role ne 'receptionist'}">
    ...
    <main class="dashboard-content">
        <div class="schedule-container">
            <div class="week-header">
                ...
                <div class="week-nav">
                    <a href="${ctx}/receptionist/schedule?week=${previousWeek}">⟵ Tuần trước</a>
                    <a href="${ctx}/receptionist/schedule?week=${nextWeek}" style="margin-left:0.5rem;">Tuần sau ⟶</a>
                </div>
            </div>
                    ...
                    <div class="day-card">
                        ...
                        <c:forEach var="s" items="${scheduleList}">
                            <c:if test="${s.workDate eq day}">
                                ...
                                <c:if test="${fn:contains(s.shift, 'Sáng')}">
                                    <c:set var="slotClass" value="morning"/>
                                </c:if>
                                <c:if test="${fn:contains(s.shift, 'Chiều')}">
                                    <c:set var="slotClass" value="afternoon"/>
                                </c:if>
                                <c:if test="${fn:contains(s.shift, 'Tối')}">
