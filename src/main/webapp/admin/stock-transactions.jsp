...
<head>
    ...
    <title>Giao Dịch Kho - Hệ Thống Nha Khoa</title>
...
<body>
    ...
    <div class="dashboard-layout">
        ...
        <div class="transactions-container">
            ...
            <div class="action-buttons" style="margin-bottom: 20px;">
                ...
                <a href="${pageContext.request.contextPath}/admin/inventory" class="btn btn-warning">📦 Quản Lý Kho</a>
            </div>
            ...
            <div class="filter-section">
                ...
                <form method="get" action="${pageContext.request.contextPath}/admin/stock-transactions">
                    ...
                    <div class="filter-row">
                        ...
                        <div class="form-group">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/stock-transactions" class="btn btn-warning">🔄 Xóa Lọc</a>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/admin/stock-transactions" method="post">
