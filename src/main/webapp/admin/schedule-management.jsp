...
<head>
    ...
    <title>Quản Lý Lịch Làm Việc - Hệ Thống Quản Lý Phòng Khám Nha Khoa</title>
        ...
        <main class="dashboard-content">
            <div class="container">
                ...
                <div class="schedule-form">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/schedules" method="post" id="scheduleForm">
                        ...
                        <div class="action-buttons">
                            <a href="${pageContext.request.contextPath}/admin/weekly-schedule" class="btn btn-secondary">
                                📊 Xem Lịch Tuần
                            </a>
