-- Seed data cuối cùng - không có lỗi duplicate variable
...
BEGIN
    ...
    -- 7 ngày trước
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient1')), (SELECT user_id FROM Users WHERE username = 'dentist1'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -7, GETDATE()), 'COMPLETED', 'Khám răng định kỳ', DATEADD(day, -7, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient2')), (SELECT user_id FROM Users WHERE username = 'dentist2'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -7, GETDATE()), 'COMPLETED', 'Nhổ răng khôn', DATEADD(day, -7, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient3')), (SELECT user_id FROM Users WHERE username = 'dentist1'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -7, GETDATE()), 'COMPLETED', 'Tư vấn niềng răng', DATEADD(day, -7, GETDATE()), 'INTERNAL'),
    -- 6 ngày trước
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient4')), (SELECT user_id FROM Users WHERE username = 'dentist3'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -6, GETDATE()), 'COMPLETED', 'Trám răng sâu', DATEADD(day, -6, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient5')), (SELECT user_id FROM Users WHERE username = 'dentist2'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -6, GETDATE()), 'COMPLETED', 'Làm sạch răng', DATEADD(day, -6, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient1')), (SELECT user_id FROM Users WHERE username = 'dentist1'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -6, GETDATE()), 'COMPLETED', 'Kiểm tra sau điều trị', DATEADD(day, -6, GETDATE()), 'INTERNAL'),
    -- 5 ngày trước
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient2')), (SELECT user_id FROM Users WHERE username = 'dentist3'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -5, GETDATE()), 'COMPLETED', 'Điều trị tủy răng', DATEADD(day, -5, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient3')), (SELECT user_id FROM Users WHERE username = 'dentist2'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -5, GETDATE()), 'COMPLETED', 'Làm răng giả', DATEADD(day, -5, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient4')), (SELECT user_id FROM Users WHERE username = 'dentist1'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -5, GETDATE()), 'COMPLETED', 'Tư vấn thẩm mỹ răng', DATEADD(day, -5, GETDATE()), 'INTERNAL'),
    -- 4 ngày trước
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient5')), (SELECT user_id FROM Users WHERE username = 'dentist3'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -4, GETDATE()), 'COMPLETED', 'Khám răng định kỳ', DATEADD(day, -4, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient1')), (SELECT user_id FROM Users WHERE username = 'dentist2'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -4, GETDATE()), 'COMPLETED', 'Điều trị viêm nướu', DATEADD(day, -4, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient2')), (SELECT user_id FROM Users WHERE username = 'dentist1'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -4, GETDATE()), 'COMPLETED', 'Kiểm tra răng khôn', DATEADD(day, -4, GETDATE()), 'INTERNAL'),
    -- 3 ngày trước
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient3')), (SELECT user_id FROM Users WHERE username = 'dentist3'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -3, GETDATE()), 'COMPLETED', 'Trám răng sâu', DATEADD(day, -3, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient4')), (SELECT user_id FROM Users WHERE username = 'dentist2'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -3, GETDATE()), 'COMPLETED', 'Làm sạch răng', DATEADD(day, -3, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient5')), (SELECT user_id FROM Users WHERE username = 'dentist1'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -3, GETDATE()), 'COMPLETED', 'Tư vấn niềng răng', DATEADD(day, -3, GETDATE()), 'INTERNAL'),
    -- 2 ngày trước
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient1')), (SELECT user_id FROM Users WHERE username = 'dentist2'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -2, GETDATE()), 'COMPLETED', 'Điều trị tủy răng', DATEADD(day, -2, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient2')), (SELECT user_id FROM Users WHERE username = 'dentist3'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -2, GETDATE()), 'COMPLETED', 'Làm răng giả', DATEADD(day, -2, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient3')), (SELECT user_id FROM Users WHERE username = 'dentist1'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -2, GETDATE()), 'COMPLETED', 'Kiểm tra sau điều trị', DATEADD(day, -2, GETDATE()), 'INTERNAL'),
    -- Hôm qua
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient4')), (SELECT user_id FROM Users WHERE username = 'dentist1'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -1, GETDATE()), 'COMPLETED', 'Khám răng định kỳ', DATEADD(day, -1, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient5')), (SELECT user_id FROM Users WHERE username = 'dentist2'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -1, GETDATE()), 'COMPLETED', 'Điều trị viêm nướu', DATEADD(day, -1, GETDATE()), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient1')), (SELECT user_id FROM Users WHERE username = 'dentist3'), (SELECT MIN(service_id) FROM Services), DATEADD(day, -1, GETDATE()), 'COMPLETED', 'Tư vấn thẩm mỹ răng', DATEADD(day, -1, GETDATE()), 'INTERNAL'),
    -- Hôm nay
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient2')), (SELECT user_id FROM Users WHERE username = 'dentist1'), (SELECT MIN(service_id) FROM Services), GETDATE(), 'SCHEDULED', 'Khám răng định kỳ', GETDATE(), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient3')), (SELECT user_id FROM Users WHERE username = 'dentist2'), (SELECT MIN(service_id) FROM Services), GETDATE(), 'SCHEDULED', 'Làm sạch răng', GETDATE(), 'INTERNAL'),
    ((SELECT patient_id FROM Patients WHERE user_id = (SELECT user_id FROM Users WHERE username = 'patient4')), (SELECT user_id FROM Users WHERE username = 'dentist3'), (SELECT MIN(service_id) FROM Services), GETDATE(), 'SCHEDULED', 'Kiểm tra răng khôn', GETDATE(), 'INTERNAL');
