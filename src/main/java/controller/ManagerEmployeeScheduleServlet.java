...
@WebServlet("/manager/employee-schedule")
public class ManagerEmployeeScheduleServlet extends HttpServlet {

    private static final Logger logger = Logger.getLogger(ManagerEmployeeScheduleServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (employeeIdParam == null || employeeIdParam.isEmpty()) {
                ...
                request.getRequestDispatcher("/manager/employee-schedule.jsp").forward(request, response);
                return;
            }
